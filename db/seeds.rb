...
User.create(email:'rita@mail.com',password:'12345678',first_name:'Rita',
            last_name:'Johnes',address:'Park Lane', city:'NY', state:'NY',zip: '38100')
...
Account.create(title: 'Orphan Account ', balance:'')
